...
<div class="container">
	<div class="container">
		...
		<div class="progress">
			<div id="progress" class="determinate red" style="width: 25%"></div>
		</div>	
	</div>	
	...
	<ul class="collapsible popout">
	  <li>
	    <div class="collapsible-header"><i class="material-icons">title</i>Título do capítulo</div>
	...
	<a href="3" class="waves-effect waves-light btn-large red">Próximo</a>
</div>
